...
import com.Balor.Tools.Configuration.ExMemoryConfigurationOption;

/**
 * Various settings for controlling the input and output of a
 * {@link ExFileConfiguration}
 */
public class ExFileConfigurationOptions extends ExMemoryConfigurationOption {
	 ...
	 * generated output of the {@link ExFileConfiguration}. It is not required
	 * to include a newline at the end of the header as it will automatically be
